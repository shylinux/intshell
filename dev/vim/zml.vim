...
syntax match zmlFunction "action"
syntax match zmlFunction "args"
syntax match zmlFunction "style"
syntax match zmlFunction "style.width"

highlight zmlConstant    ctermfg=magenta
syntax match zmlConstant "auto"
syntax match zmlConstant "username"
